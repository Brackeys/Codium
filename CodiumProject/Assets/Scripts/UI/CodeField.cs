...
namespace UnityEngine.UI
{
	...
	[AddComponentMenu("UI/Codium/Code Field")]
		...
		ICanvasElement
	{
		...
		public Graphic placeholder { get { return m_Placeholder; } set { m_Placeholder = value; } }

		public Color selectionColor { get { return m_SelectionColor; } set { m_SelectionColor = value; } }

		public SubmitEvent onEndEdit { get { return m_EndEdit; } set { m_EndEdit = value; } }

		public OnChangeEvent onValueChange { get { return m_OnValueChange; } set { m_OnValueChange = value; } }

		public OnValidateInput onValidateInput { get { return m_OnValidateInput; } set { m_OnValidateInput = value; } }

		public int characterLimit { get { return m_CharacterLimit; } set { m_CharacterLimit = value; } }

		// Content Type related

		public ContentType contentType { get { return m_ContentType; } set { m_ContentType = value; EnforceContentType(); } }

		public LineType lineType { get { return m_LineType; } set { m_LineType = value; SetToCustomIfContentTypeIsNot(ContentType.Standard, ContentType.Autocorrected); } }

		public InputType inputType { get { return m_InputType; } set { m_InputType = value; SetToCustom(); } }

		public TouchScreenKeyboardType keyboardType { get { return m_KeyboardType; } set { m_KeyboardType = value; SetToCustom(); } }

		public CharacterValidation characterValidation { get { return m_CharacterValidation; } set { m_CharacterValidation = value; SetToCustom(); } }

		// Derived property
		public bool multiLine { get { return m_LineType == LineType.MultiLineNewline || lineType == LineType.MultiLineSubmit; } }
		// Not shown in Inspector.
		public char asteriskChar { get { return m_AsteriskChar; } set { m_AsteriskChar = value; } }
		...
		protected int GetCharacterIndexFromPosition(Vector2 pos)
		{
			...
			for (int i = startCharIndex; i < endCharIndex; i++)
			{
				...
				{
					//Debug.Log(distToCharStart + "  " + distToCharEnd + "        " + i);
					return i;
				}
			}

			
			//Custom end char selection
			if (line == gen.lineCount - 1)
			{
				return endCharIndex;

			}
			return Mathf.Clamp (endCharIndex - 1, 0, 999999);
		}
		...
		protected EditState KeyPressed(Event evt)
		{
			...
			switch (evt.keyCode)
			{
				...
				case KeyCode.A:
					{
						// Doesn't work when testet.
						// Maybe consumed by the editor.
						if (ctrlOnly)
						{
							SelectAll();
							return EditState.Continue;
		...
		private void MoveUp(bool shift)
		{
			...
			int position = multiLine ? LineUpCharacterPosition(caretSelectPositionInternal, false) : 0;
		...
		protected virtual void Append(char input, bool update)
		{
			if (!InPlaceEditing())
				return;
		...
		private void CreateCursorVerts()
		{
			...
			for (int i = 0; i < m_CursorVerts.Length; i++)
			{
				...
				m_CursorVerts[i].color = m_CaretColor;
		...
		// Not pretty but it works (enforce selection)
		void OnGUI()
		{
			if (!m_isSelected && m_AllowInput)
				m_Select();
		}
